...
public class SandboxArreglos
{
    ...
    {
    	String[] nuevoCadenas = new String[arregloCadenas.length + 1];
        for (int i = 0; i < arregloCadenas.length; i++) {
            nuevoCadenas[i] = arregloCadenas[i];
        }
    ...
    public void eliminarEntero( int valor )
    {
        ...
        for (int i = 0; i < arregloEnteros.length; i++) {
            if (arregloEnteros[i] != valor) {
                arregloEnteros[c] = arregloEnteros[i];
                c++;
            }
        }
        int[] nuevo = new int[c];
        System.arraycopy(arregloEnteros, 0, nuevo, 0, c);
    ...
    public void eliminarCadena( String cadena )
    {
        ...
        for (int i = 0; i < arregloCadenas.length; i++) {
            if (arregloCadenas[i] != cadena) {
                arregloCadenas[c] = arregloCadenas[i];
                c++;
            }
        }
        String[] nuevo = new String[c];
        System.arraycopy(arregloCadenas, 0, nuevo, 0, c);
    ...
    {
    	if (posicion >= 0 && posicion < arregloEnteros.length) {int[] nuevo = new int[arregloEnteros.length - 1];
    	System.arraycopy(arregloEnteros, 0, nuevo, 0, posicion);

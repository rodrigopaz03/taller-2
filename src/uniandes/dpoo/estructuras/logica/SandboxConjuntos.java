...
public class SandboxConjuntos
{
    ...
    public List<String> getCadenasComoListaInvertida( )
    {
        ...
        List<String> listaInvertida = new ArrayList<>(arbolCadenas.size());
       
        for (int i = listaCadenas.size() - 1; i >= 0; i--) {
            listaInvertida.add(listaCadenas.get(i));
        }
    ...
    {
    	String upperCaseCadena = cadena.toUpperCase();
        arbolCadenas.removeIf(s -> s.toUpperCase().equals(upperCaseCadena));
    }
